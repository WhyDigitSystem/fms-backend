...
@Entity
@Table(name = "ef_sejobs")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class JobCardSOVO {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ef_sejobsgen")
	@SequenceGenerator(name = "ef_sejobsgen", sequenceName = "ef_sejobsseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "ef_sejobsid")
	private Long id;
	@Column(name = "ordno")
